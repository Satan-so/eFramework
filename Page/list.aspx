<%@ Page Title="列表页DEMO" Language="C#" MasterPageFile="~/GHY.Master" AutoEventWireup="true" Inherits="GHY.EF.Page.list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <EF:InfoRepeater ID="listRepeater" runat="server" NodeId="1" PageSize="20" CacheTime="1" ConnectionStringName="EFConnectionString">
        <HeaderTemplate>
            <ul>
        </HeaderTemplate>
        <ItemTemplate>
